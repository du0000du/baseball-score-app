    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">外野方向</h3>
          <span className="text-xs text-gray-400">{ofTotal} 打球</span>
        </div>

        {ofTotal === 0 ? (
          <p className="text-center text-gray-400 text-sm py-10">外野方向のデータがありません</p>
        ) : (
          <>
            ...
            <div className="flex flex-wrap gap-x-3 gap-y-1 justify-center mt-2">
              {OUTFIELD_ORDER.map(dir => (
                <div key={dir} className="flex items-center gap-1 text-xs text-gray-500">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">内野方向</h3>
          <span className="text-xs text-gray-400">{ifTotal} 打球</span>
        </div>

        {ifTotal === 0 ? (
          <p className="text-center text-gray-400 text-sm py-10">内野方向のデータがありません</p>
        ) : (
          <>
