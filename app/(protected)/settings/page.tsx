    ...
    <div className="max-w-lg space-y-6">
      ...
      <div className="bg-white dark:bg-night-800 rounded-xl shadow-sm border border-gray-100 dark:border-night-600 p-6 space-y-5">
        ...
        <div>
          ...
          <input type="text" value={teamName} onChange={(e) => setTeamName(e.target.value)} placeholder="例: Tigers" className={inputClass} />
        </div>
        <div>
          <label className={labelClass}>名前</label>
          <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="例: 山田太郎" className={inputClass} />
        </div>
        <div>
